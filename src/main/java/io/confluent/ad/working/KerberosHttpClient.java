...
public class KerberosHttpClient {
    ...
    // FIXME: This one will need to have an SPN configured - I may be able to get it working once this work is done.

    public static void main(String[] args) throws UnsupportedOperationException, IOException {
        System.setProperty("java.security.krb5.conf", "src/main/resources/krb5.conf");
        KerberosHttpClient restTest = new KerberosHttpClient("kafka/WIN-7F40HNU7OPJ@AD-TEST.CONFLUENT.IO",
                "src/main/resources/kafka.keytab", true);
        HttpResponse response = restTest.callRestUrl("http://www.example.com",
                "kafka/WIN-7F40HNU7OPJ@AD-TEST.CONFLUENT.IO");
